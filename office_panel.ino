...
#define PIN_GRID            2
#define PIN_EMERGENCY_PUSH  3
#define PIN_EMERGENCY_BLINK 4
#define PIN_ON_AIR_TOGGLE   5
...
void setup() {
    ...
    pinMode(PIN_EMERGENCY_BLINK, OUTPUT);
    pinMode(PIN_EMERGENCY_PUSH, INPUT);
    pinMode(PIN_ON_AIR_TOGGLE, INPUT);
...
void loop() {
    int on_air = digitalRead(PIN_ON_AIR_TOGGLE);
    int emergency = digitalRead(PIN_EMERGENCY_PUSH);
